...
<body>
    <header>
        <!--Navbar-->
        <nav class="navbar fixed-top navbar-expand-lg bg-body-dark shadow-sm justify-content-between">
            <div class="container-fluid">
                <h5 class="container text-light"
                    style="font-family: 'Comic Sans MS', sans-serif; font-weight: bold; color: dark;">
                    Perpustakaan Zenik<img src="assets/header.png" alt="Logo"
    ...
    <section id="homeSection" class="p-3">
       ...
       <div class="input-group d-flex justify-content-center mb-3">
         <input style="width:56%;" class="border p-2 rounded rounded-end-0 bg-dark text-light" type="text" name="keyword" id="keyword" placeholder="cari data buku...">
        ...
        <footer id="footer" class="p-1 bg-body-dark">
            <div class="container">
