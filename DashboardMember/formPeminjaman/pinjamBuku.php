...
<div class="input-group mb-3 mt-1">
    ...
    <a class="btn btn-light text-dark" href="../dashboardMember.php"> Batal</a>
    <button type="submit" class="btn btn-light text-dark" name="pinjam">Pinjam</button>
    </form>
            </div>
        </div>
    </div>
    ...
    <footer id="footer" class="p-1 bg-dark">
            <div class="container">
                <div class="d-flex justify-content-center align-items-center mt-2">
                    <p class="text-light"><i>Selamat Datang di Perpustakaan Kami All Rights Reserved</i></p>
                </div>
            </div>
        </footer>
