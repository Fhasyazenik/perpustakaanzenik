    ...
    <div class="table-container">
      <table class="table table-striped table-hover" width="100%">
        <thead class="text-center text-light">
          <tr>
        <th class="bg-dark text-light" width="5%">NO</th>
        <th class="bg-dark text-light">Id Buku</th>
        <th class="bg-dark text-light">Judul Buku</th>
        <th class="bg-dark text-light">Nama Siswa</th>
        <th class="bg-dark text-light" width="5%">Nama Admin</th>
        <th class="bg-dark text-light">Tanggal Peminjaman</th>
        <th class="bg-dark text-light">Tanggal Berakhir</th>
        <th class="bg-dark text-light" width="10%">Harga</th>
        <th class="bg-dark text-light" width="15%">Aksi</th>
      </tr>
      </thead>
      ...
      <td>
        <div class="btn-group" role="group">
          <?php if ($item["status"] == 'Konfirmasi') : ?>
            <div class="butt" style="margin-right:20px ;">
            <a class="btn btn-dark text-light" href="bacabuku.php?pdf=<?= urlencode("../../isi-buku/" . $item["isi_buku"]); ?>">Baca Buku</a>
            </div>
            <div class="butt">
            <a href="pinjam.php?id=<?= $item['id_peminjaman']; ?>" class="btn btn-dark text-light">Kembalikan Buku</a>
            </div>
          <?php elseif ($item["status"] == 'Belum konfirmasi') : ?>
            ...
            <?php else : ?>
              <a href="upload_bukti.php?id=<?= $item['id_peminjaman']; ?>" class="btn btn-dark">Pembayaran</a>
            <?php endif; ?>
          <?php endif; ?>
        </div>
      </td>
