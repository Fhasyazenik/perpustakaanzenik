...
<br>
  ...
  <div class="card-body d-flex flex-column bg-dark justify-content-between align-items-center" style="height: 100%;">
    ...
    <div class="d-flex justify-content-between w-100">
      <a class="btn btn-light text-dark w-48" href="buku/detailBuku.php?id=<?= $item["id_buku"]; ?>">Detail</a>
      <a href="formPeminjaman/pinjamBuku.php?id=<?= $item["id_buku"]; ?>" class="btn btn-light text-dark w-48">Pinjam</a>
    </div>
  </div>
</div>  <?php endforeach; ?>
                </div>
