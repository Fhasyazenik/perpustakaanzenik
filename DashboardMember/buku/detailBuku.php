...
<html lang="en">
  ...
  <?php endforeach; ?>
  <div class="card-body">
    <a href="../dashboardMember.php" class="btn btn-light text-dark">Batal</a>
     <a href="../formPeminjaman/pinjamBuku.php?id=<?= $item["id_buku"]; ?>" class="btn btn-light text-dark">Pinjam</a>
     </div>
    </div>
   </div>
  </div>
