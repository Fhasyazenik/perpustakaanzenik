    ...
    <h1 class="container text-center mb-3 header-text"
      ...
      <!--search engine --->
       <div class="input-group d-flex justify-content-end mb-3">
        <a class="btn btn-dark border-light p-2" href="tambah.php">Tambah Akun</a> 
         <input class="border p-2 rounded rounded-end-0 bg-dark" type="text" name="keyword" id="keyword" placeholder="cari data member...">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="action">
                        <a href="deleteMember.php?id=<?= $item["nisn"]; ?>" class="btn btn-dark" onclick="return confirm('Yakin ingin menghapus data member ?');"><i class="fa-solid fa-trash"></i></a>
                    </div>
                </td>
            </tr>
            <?php endforeach;?>
