...
<body>
<!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-light bg-body-dark fixed-top">
    <div class="container-fluid">
    <h5 class="container text-light" style="font-family: 'Comic Sans MS', sans-serif; font-weight: bold; color: dark;">
      Perpustakaan Zenik<img src="../assets/header.png" alt="Logo" style="width: 40px; height: 40px; border-radius: 50%; margin-left: 10px;">
    </h5>
...
<br>
    ...
    <section id="homeSection" class="p-5">
       ...
       <div class="input-group d-flex justify-content-center mb-3">
         <input style="width:38%;" class="border p-2 rounded rounded-end-0 bg-dark" type="text" name="keyword" id="keyword" placeholder="cari data buku...">
         <button class="border border-start-0 bg-dark text-light rounded rounded-start-0" type="submit" name="search"><i class="fa-solid fa-magnifying-glass"></i></button>
       </div>
      </form>
        <!-- Form and Buttons -->
        <!-- Tombol Kategori -->
        <form action="" method="post">
            <div class="container kategori-buttons text-dark"
                ...
                <button class="btn btn-dark text-light border-light" type="submit">Semua</button>
                <button type="submit" name="informatika" class="border-light btn btn-dark">Informatika</button>
                <button type="submit" name="bisnis" class="btn btn-dark border-light">Bisnis</button>
                <button type="submit" name="filsafat" class="btn btn-dark border-light">Filsafat</button>
                <button type="submit" name="novel" class="btn btn-dark border-light">Novel</button>
                <button type="submit" name="sains" class="btn btn-dark border-light">Sains</button>
            </div>
        </form>
  ...
  <div class="card-body bg-dark d-flex flex-column justify-content-between align-items-center" style="height: 100%;">
    <h6 class="card-title text-light" style="white-space: normal; overflow: hidden; text-overflow: ellipsis;"><?= $item["judul"]; ?></h6>
    <ul align="center" style="font-family: 'Comic Sans MS', sans-serif; color: dark;" class="list-group list-group-flush">
      <li class="list-group-item text-light bg-dark">Kategori : <?= $item["kategori"]; ?></li>
    </ul>
    <div class="d-flex justify-content-between w-100">
    <a class="btn btn-light text-dark" href="buku/updateBuku.php?idReview=<?= $item["id_buku"]; ?>" id="review">Edit</a>
      <a class="btn btn-light text-dark" href="buku/deleteBuku.php?id=<?= $item["id_buku"]; ?>" onclick="return confirm('Yakin ingin menghapus data buku ? ');">Delete</a>
    </div>
  </div>
</div>  <?php endforeach; ?>
                </div>
        ...
        <footer id="footer" class="p-1 bg-dark">
            <div class="container">
                <div class="d-flex justify-content-center align-items-center mt-2">
                    <p class="text-light"><i>Selamat Datang di Perpustakaan Kami</i></p>
                </div>
            </div>
        </footer>
