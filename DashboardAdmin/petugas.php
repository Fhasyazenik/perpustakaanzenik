...
<nav class="navbar navbar-expand-lg navbar-light bg-body-dark fixed-top">
    ...
    <table class="table table-striped table-hover">
        <thead class="text-center">
            <tr>
                <th class="bg-dark text-light">ID Admin</th>
                <th class="bg-dark text-light">Nama Lengkap</th>
                <th class="bg-dark text-light">Password</th>
                <th class="bg-dark text-light">Kode</th>
                <th class="bg-dark text-light">Tanggal Pengembalian</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $data["no_tlp"]; ?></td>
                <td><?= $data["sebagai"]; ?></td>
                <td><a href="deletepetugas.php?id=<?= $data["id"]; ?>" class="btn btn-dark" onclick="return confirm('Yakin ingin menghapus data member ?');"><i class="fa-solid fa-trash"></i></a></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
  ...
  <select class="form-select" id="sebagai" name="sebagai">
    ...
    <option value="petugas">petugas</option>
            ...
            <div class="form-group">
            <button type="submit" name="signup" class="btn btn-light text-dark">Tambah Petugas</button>
        </form>
    </div>
    <script>
